...
from superset.views.webReportViewer.mixin import DashboardMixin


class WebReportViewerModelView(DashboardMixin, SupersetModelView, DeleteMixin):  # pylint: disable=too-many-ancestors
    route_base = "/webReportViewer"
    ...
    def mulexport(
        self,
        items: Union["WebReportViewerView", builtins.list["WebReportViewerView"]],
    ) -> FlaskResponse:
...
class WebReportViewerView(BaseSupersetView):
    """The base views for Superset!"""

    class_permission_name = "WebReportViewer"
    method_permission_name = MODEL_VIEW_RW_METHOD_PERMISSION_MAP
...
class WebReportViewerModelViewAsync(WebReportViewerView):  # pylint: disable=too-many-ancestors
