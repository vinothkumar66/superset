...
export default function SupersetStyleTable() {
    ...
    const handleReportClick = (report: Report) => {
        ...
        const apiUrl = fileExtension === 'png'
    ...
    const reportFileBodyTemplate = (rowData: Report) => (
        <a href="#" onClick={() => handleReportClick(rowData)} style={{ color: '#1a73e8', cursor: 'pointer' }}>
            {rowData.report_file}
        </a>
    );
    ...
    return (
        <div className="card superset-table">
            ...
            {activeTab === 'table' ? (
                ...
                >
                    <Column field="report_file" header="Report Name" body={reportFileBodyTemplate} sortable />
                    <Column field="creation_time" header="CreatedAt" body={creationTimeBodyTemplate} sortable />
                </DataTable>
            ) : (
                <Tree value={treeData} />
            )}
