...
import {
  ...
  REPORTVIEWER_TITLE_CHANGED,
} from '../actions/reportViewerLayout';
...
const actionHandlers = {
  [HYDRATE_REPORTVIEWER](state, action) {
    return {
      ...action.data.reportViewerLayout.present,
    };
  },
  ...
  [CREATE_TOP_LEVEL_TABS](state, action) {
    ...
    const rootComponent = state[REPORTVIEWER_ROOT_ID];
    ...
    newEntities[REPORTVIEWER_ROOT_ID] = {
      ...rootComponent,
  ...
  [DELETE_TOP_LEVEL_TABS](state) {
    ...
    nextEntities[REPORTVIEWER_ROOT_ID] = {
      ...rootComponent,
      children: [REPORTVIEWER_GRID_ID],
    };

    nextEntities[REPORTVIEWER_GRID_ID] = {
      ...state[REPORTVIEWER_GRID_ID],
  ...
  [UPDATE_COMPONENTS_PARENTS_LIST](state) {
    ...
    updateComponentParentsList({
      currentComponent: nextState[REPORTVIEWER_ROOT_ID],
      layout: nextState,
    });
  ...
  [REPORTVIEWER_TITLE_CHANGED](state, action) {
    return {
      ...state,
      [REPORTVIEWER_HEADER_ID]: {
        ...state[REPORTVIEWER_HEADER_ID],
        meta: {
          ...state[REPORTVIEWER_HEADER_ID].meta,
          text: action.text,
        },
      },
    };
