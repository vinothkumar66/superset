...
import { getReportViewerPermalink } from 'src/utils/urlUtils';
...
interface ShareMenuItemProps {
  ...
  reportViewerId: string | number;
  reportViewerComponentId?: string;
...
const ShareMenuItems = (props: ShareMenuItemProps) => {
  ...
  async function generateUrl() {
    return getReportViewerPermalink({
      reportViewerId,
      dataMask,
      activeTabs,
      anchor: reportViewerComponentId,
    });
  }
