...
import URLShortLinkButton from 'src/reportViewer/components/URLShortLinkButton';
import ToastContainer from 'src/components/MessageToasts/ToastContainer';

const REPORTVIEWER_ID = 10;
...
fetchMock.get(
  `glob:*/api/v1/reportViewer/${REPORTVIEWER_ID}/filter_state*`,
  FILTER_STATE_PAYLOAD,
);

fetchMock.post(
  `glob:*/api/v1/reportViewer/${REPORTVIEWER_ID}/permalink`,
  PERMALINK_PAYLOAD,
);
...
test('renders error message on short url error', async () => {
  fetchMock.mock(`glob:*/api/v1/reportViewer/${REPORTVIEWER_ID}/permalink`, 500, {
