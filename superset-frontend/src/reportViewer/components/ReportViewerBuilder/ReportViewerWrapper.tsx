...
const StyledDiv = styled.div`
  ${({ theme }) => css`
    ...
    .reportViewer-component-tabs .dragdroppable-column .hover-menu--top {
    ...
    .reportViewer-component-tabs > .hover-menu-container > .hover-menu--left {
      top: 0;
      transform: unset;
    ...
    .dragdroppable-column .reportViewer-component-chart-holder .hover-menu--top,
    .dragdroppable .reportViewer-component-header .hover-menu--top {
...
const ReportViewerWrapper: FC<Props> = ({ children }) => {
