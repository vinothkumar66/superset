...
import { Layout } from 'src/reportViewer/types';
import { ChartState } from 'src/explore/types';

interface ReportViewerInfo {
  id: number;
  userId: string | undefined;
  reportedit_perm: boolean;
  reportsave_perm: boolean;
...
export interface HeaderProps {
  ...
  shouldPersistRefreshFrequency: boolean;
  setRefreshFrequency: () => void;
  reportViewerInfoChanged: () => void;
  reportViewerTitleChanged: () => void;
}
