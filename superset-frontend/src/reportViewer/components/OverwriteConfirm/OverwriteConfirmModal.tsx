...
import { ReportViewerState } from 'src/reportViewer/types';
import {
  saveReportViewerRequest,
  setOverrideConfirm,
} from 'src/reportViewer/actions/reportViewerState';
import { t, styled } from '@superset-ui/core';
import { SAVE_TYPE_OVERWRITE_CONFIRMED } from 'src/reportViewer/util/constants';
...
type Props = {
  overwriteConfirmMetadata: ReportViewerState['overwriteConfirmMetadata'];
};
    ...
    if (overwriteConfirmMetadata) {
      dispatch(
        saveReportViewerRequest(
          ...
          overwriteConfirmMetadata.reportViewerId,
