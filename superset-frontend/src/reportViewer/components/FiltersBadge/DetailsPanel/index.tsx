...
import {
  ...
  Separator,
  SectionName,
} from 'src/reportViewer/components/FiltersBadge/Styles';
import { Indicator } from 'src/reportViewer/components/nativeFilters/selectors';
import FilterIndicator from 'src/reportViewer/components/FiltersBadge/FilterIndicator';
