...
import DragDroppable from 'src/reportViewer/components/dnd/DragDroppable';
import EditableTitle from 'src/components/EditableTitle';
import Tab, {
  RENDER_TAB,
  RENDER_TAB_CONTENT,
} from 'src/reportViewer/components/gridComponents/Tab';
...
describe('Tabs', () => {
  const props = {
    ...
    parentComponent: reportViewerLayoutWithTabs.present.TABS_ID,
    index: 0,
    depth: 1,
    editMode: false,
