...
import {
  Draggable,
  Droppable,
} from 'src/reportViewer/components/dnd/DragDroppable';
...
import { BACKGROUND_TRANSPARENT } from 'src/reportViewer/util/constants';
import { EMPTY_CONTAINER_Z_INDEX } from 'src/reportViewer/constants';
...
const ColumnStyles = styled.div`
  ${({ theme, editMode }) => css`
    ...
    .reportViewer--editing .resizable-container--resizing:hover > &:after,
    .reportViewer--editing .hover-menu:hover + &:after {
