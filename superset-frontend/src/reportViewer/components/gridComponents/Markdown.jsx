...
import MarkdownModeDropdown from 'src/reportViewer/components/menu/MarkdownModeDropdown';
...
import { ROW_TYPE, COLUMN_TYPE } from 'src/reportViewer/util/componentTypes';
import {
    ...
    return (
      ...
      >
        {({ dragSourceRef }) => (
          ...
          >
            <MarkdownStyles
              data-test="reportViewer-markdown-editor"
              className={cx(
                'reportViewer-markdown',
                isEditing && 'reportViewer-markdown--editing',
              )}
              id={component.id}
            >
              <ResizableContainer
              ...
              >
                <div
                  ref={dragSourceRef}
                  className="reportViewer-component reportViewer-component-chart-holder"
...
function mapStateToProps(state) {
  return {
    undoLength: state.reportViewerLayout.past.length,
    redoLength: state.reportViewerLayout.future.length,
