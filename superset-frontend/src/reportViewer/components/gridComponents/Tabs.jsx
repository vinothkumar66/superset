...
import { LOG_ACTIONS_SELECT_REPORTVIEWER_TAB } from 'src/logger/LogUtils';
import { AntdModal } from 'src/components';
import { Draggable } from '../dnd/DragDroppable';
import DragHandle from '../dnd/DragHandle';
import ReportViewerComponent from '../../containers/ReportViewerComponent';
...
const propTypes = {
  ...
  // actions (from ReportViewerComponent.jsx)
...
export class Tabs extends PureComponent {
  ...
  UNSAFE_componentWillReceiveProps(nextProps) {
    ...
    // reset tab index if reportViewer was changed
    if (nextProps.reportViewerId !== this.props.reportViewerId) {
  ...
  showDeleteConfirmModal = key => {
    ...
    AntdModal.confirm({
      title: t('Delete reportViewer tab?'),
      content: (
        <span>
          {t(
  ...
  handleClickTab(tabIndex) {
    ...
    if (tabIndex !== this.state.tabIndex) {
      ...
      this.props.logEvent(LOG_ACTIONS_SELECT_REPORTVIEWER_TAB, {
    ...
    return (
      ...
      >
        {({ dragSourceRef: tabsDragSourceRef }) => (
          <StyledTabsContainer
            className="reportViewer-component reportViewer-component-tabs"
            data-test="reportViewer-component-tabs"
          >
...
function mapStateToProps(state) {
  return {
    ...
    activeTabs: state.reportViewerState.activeTabs,
    directPathToChild: state.reportViewerState.directPathToChild,
  };
}
