...
import NewTabs from 'src/reportViewer/components/gridComponents/new/NewTabs';

import { NEW_TABS_ID } from 'src/reportViewer/util/constants';
import { TABS_TYPE } from 'src/reportViewer/util/componentTypes';
