...
import NewDivider from 'src/reportViewer/components/gridComponents/new/NewDivider';

import { NEW_DIVIDER_ID } from 'src/reportViewer/util/constants';
import { DIVIDER_TYPE } from 'src/reportViewer/util/componentTypes';
