...
import NewHeader from 'src/reportViewer/components/gridComponents/new/NewHeader';

import { NEW_HEADER_ID } from 'src/reportViewer/util/constants';
import { HEADER_TYPE } from 'src/reportViewer/util/componentTypes';
