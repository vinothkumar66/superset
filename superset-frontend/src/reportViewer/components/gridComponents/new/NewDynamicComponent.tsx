...
import { ReportViewerComponentsRegistryMetadata } from '../../../../visualizations/reportViewerComponents/ReportViewerComponentsRegistry';

type DraggableNewDynamicComponent = {
  componentKey: string;
  metadata: ReportViewerComponentsRegistryMetadata;
};
