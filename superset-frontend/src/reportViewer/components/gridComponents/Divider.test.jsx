...
import Divider from 'src/reportViewer/components/gridComponents/Divider';
...
describe('Divider', () => {
  const props = {
    ...
    depth: 1,
    parentComponent: newComponentFactory(REPORTVIEWER_GRID_TYPE),
    index: 0,
    editMode: false,
    handleComponentDrop() {},
    deleteComponent() {},
  ...
  it('should render a div with class "reportViewer-component-divider"', () => {
    const wrapper = setup();
    expect(wrapper.find('.reportViewer-component-divider')).toExist();
  });
