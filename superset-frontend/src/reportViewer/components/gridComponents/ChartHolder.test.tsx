...
import { SET_DIRECT_PATH } from 'src/reportViewer/actions/reportViewerState';
...
describe('ChartHolder', () => {
  ...
  it('should render anchor link when not editing', async () => {
    ...
    expect(
      screen.getByTestId('reportViewer-component-chart-holder'),
    ).toBeVisible();

    expect(
      screen
        .getByTestId('reportViewer-component-chart-holder')
  ...
  it('should highlight when path matches', async () => {
    ...
    expect(screen.getByTestId('reportViewer-component-chart-holder')).toHaveClass(
      'fade-out',
    );
  ...
  it('should call deleteComponent when deleted', async () => {
    ...
    expect(
      screen.queryByTestId('reportViewer-delete-component-button'),
    ...
    expect(
      screen.getByTestId('reportViewer-delete-component-button'),
    ).toBeInTheDocument();

    userEvent.hover(screen.getByTestId('reportViewer-component-chart-holder'));
