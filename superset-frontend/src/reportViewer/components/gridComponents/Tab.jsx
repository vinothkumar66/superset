...
import { TAB_TYPE } from 'src/reportViewer/util/componentTypes';
...
class Tab extends PureComponent {
  ...
  renderTabContent() {
    ...
    return (
      <div className="reportViewer-component-tabs-content">
            ...
            description={
              ...
              (editMode ? (
                <span>
                  {t('You can')}{' '}
                  <a
                    href={`/chart/add?reportViewer_id=${reportViewerId}`}
        ...
        {({ dropIndicatorProps, dragSourceRef }) => (
          ...
          >
            ...
            {!editMode && (
              <AnchorLink
                id={component.id}
                reportViewerId={this.props.reportViewerId}
...
function mapStateToProps(state) {
  return {
    canEdit: state.reportViewerInfo.reportedit_perm,
  };
}
