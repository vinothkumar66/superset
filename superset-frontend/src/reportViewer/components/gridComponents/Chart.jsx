...
import {
  ...
  LOG_ACTIONS_EXPORT_XLSX_REPORTVIEWER_CHART,
...
const propTypes = {
  ...
  // all active filter fields in reportViewer
...
// resizing across all slices on a reportViewer on every update
...
const ChartWrapper = styled.div`
  ...
  &.reportViewer-chart--overflowable {
    overflow: visible;
  }
`;
...
class Chart extends Component {
  ...
  changeFilter(newSelectedValues = {}) {
    this.props.logEvent(LOG_ACTIONS_CHANGE_REPORTVIEWER_FILTER, {
  ...
  logExploreChart = () => {
    this.props.logEvent(LOG_ACTIONS_EXPLORE_REPORTVIEWER_CHART, {
  ...
  render() {
    ...
    // references a chart that is not associated with the reportViewer
    if (!chart || !slice) {
    ...
    return (
      ...
      >
        ...
        */}
        ...
        <ChartWrapper
          className={cx('reportViewer-chart')}
