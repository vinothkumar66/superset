...
import { slicePropShape } from 'src/reportViewer/util/propShapes';
...
class SliceAdder extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      showOnlyMyCharts: getItem(
        LocalStorageKeys.ReportViewerEditorShowOnlyMyCharts,
        true,
      ),
    };
  ...
  onShowOnlyMyCharts(showOnlyMyCharts) {
    ...
    setItem(LocalStorageKeys.ReportViewerEditorShowOnlyMyCharts, showOnlyMyCharts);
  }
      ...
      >
        <NewChartButtonContainer>
          <NewChartButton
            ...
            onClick={() =>
              window.open(
                `/chart/add?reportViewer_id=${this.props.reportViewerId}`,
                '_blank',
                'noopener noreferrer',
              )
            }
        ...
        <Controls>
          <Input
            ...
            data-test="reportViewer-charts-filter-search-input"
          />
          <StyledSelect
