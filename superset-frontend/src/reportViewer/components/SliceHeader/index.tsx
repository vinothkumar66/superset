...
} from 'src/reportViewer/components/SliceHeaderControls';
import FiltersBadge from 'src/reportViewer/components/FiltersBadge';
...
import { ReportViewerPageIdContext } from 'src/reportViewer/containers/ReportViewerPage';
...
const SliceHeader: FC<SliceHeaderProps> = ({
  ...
  const SliceHeaderExtension = extensionsRegistry.get('reportViewer.slice.header');
  const uiConfig = useUiConfig();
  const reportViewerPageId = useContext(ReportViewerPageIdContext);
  ...
  const exploreUrl = `/explore/?reportViewer_page_id=${reportViewerPageId}&slice_id=${slice.slice_id}`;
