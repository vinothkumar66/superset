...
import SliceAdder from 'src/reportViewer/containers/SliceAdder';
import reportViewerComponents from 'src/visualizations/presets/reportViewerComponents';
...
const BuilderComponentPane = ({ topOffset = 0 }) => (
  <div
    data-test="reportViewer-builder-sidepane"
    css={css`
      position: sticky;
      right: 0;
      top: ${topOffset}px;
  ...
  >
    ...
    >
      <Tabs
        data-test="reportViewer-builder-component-pane-tabs-navigation"
        id="tabs"
        css={(theme: SupersetTheme) => css`
          line-height: inherit;
