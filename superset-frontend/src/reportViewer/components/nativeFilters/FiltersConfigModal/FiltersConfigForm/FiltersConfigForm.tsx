...
import {
  getFormData,
  mergeExtraFormData,
} from 'src/reportViewer/components/nativeFilters/utils';
    ...
    >
      ...
      >
        ...
        {formFilter?.filterType === 'filter_time' && (
          <FilterTypeInfo>
            {t(`ReportViewer time range filters apply to temporal columns defined in
          the filter section of each chart. Add temporal columns to the chart
          filters to have this reportViewer filter impact those charts.`)}
          </FilterTypeInfo>
        )}
        {hasDataset && (
          <StyledRowContainer>
              ...
              {hasDataset && hasAdditionalFilters && (
                <CleanFormItem name={['filters', filterId, 'preFilter']}>
                  <CollapsibleControl
                    ...
                    do not impact how the filter is applied to the reportViewer. This is useful
