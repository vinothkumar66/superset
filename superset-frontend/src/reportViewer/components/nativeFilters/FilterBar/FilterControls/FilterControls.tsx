...
import {
  useReportViewerHasTabs,
  useSelectFiltersInScope,
} from 'src/reportViewer/components/nativeFilters/state';
import {
  ReportViewerLayout,
...
const FilterControls: FC<FilterControlsProps> = ({
  ...
  const selectedCrossFilters = useMemo(
    () =>
      isCrossFiltersEnabled
        ...
        : [],
    [chartConfiguration, reportViewerLayout, dataMask, isCrossFiltersEnabled],
  );
  ...
  const showCollapsePanel = reportViewerHasTabs && filtersWithValues.length > 0;
