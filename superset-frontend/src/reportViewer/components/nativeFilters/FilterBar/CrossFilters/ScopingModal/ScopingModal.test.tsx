...
const REPORTVIEWER_UPDATE_URL = 'glob:*api/v1/reportViewer/1';
beforeEach(() => {
  fetchMock.put(REPORTVIEWER_UPDATE_URL, 200);
});
...
it('edit scope and save', async () => {
  ...
  await waitFor(() => fetchMock.called(REPORTVIEWER_UPDATE_URL));
