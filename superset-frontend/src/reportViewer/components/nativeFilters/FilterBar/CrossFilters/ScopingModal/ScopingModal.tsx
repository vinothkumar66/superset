...
import { saveChartConfiguration } from 'src/reportViewer/actions/reportViewerInfo';
import { DEFAULT_CROSS_FILTER_SCOPING } from 'src/reportViewer/constants';
...
export const ScopingModal = ({
  ...
  >(
    state =>
      state.reportViewerInfo.metadata?.global_chart_configuration ||
