...
import { setFilterConfiguration } from 'src/reportViewer/actions/nativeFilters';
import Button from 'src/components/Button';
import { FilterConfiguration, styled } from '@superset-ui/core';
import FiltersConfigModal from 'src/reportViewer/components/nativeFilters/FiltersConfigModal/FiltersConfigModal';
  ...
  return (
    <>
      ...
      <FiltersConfigModal
        ...
        key={`filters-for-${reportViewerId}`}
      />
    </>
  );
};
