...
export const useInitialization = () => {
  ...
  // We need to know how much charts now shown on reportViewer to know how many of all charts should be loaded
  ...
  useEffect(() => {
    ...
    // For some reportViewers may be there are no charts on first page,
