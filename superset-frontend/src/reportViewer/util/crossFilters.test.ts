...
test('Generate correct cross filters configuration without initial configuration', () => {
  ...
  // @ts-ignore
  expect(getCrossFiltersConfiguration(REPORTVIEWER_LAYOUT, {}, CHARTS)).toEqual({
    chartConfiguration: {
      '1': {
        id: 1,
        crossFilters: {
...
test('Return undefined if REPORTVIEWER_CROSS_FILTERS feature flag is disabled', () => {
  // @ts-ignore
  global.featureFlags = {
