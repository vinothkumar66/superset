...
import { ChartConfiguration, ChartQueryPayload } from 'src/reportViewer/types';
import { getExtraFormData } from 'src/reportViewer/components/nativeFilters/utils';
import { areObjectsEqual } from 'src/reduxUtils';
import getEffectiveExtraFilters from './getEffectiveExtraFilters';
import { getAllActiveFilters } from '../activeAllReportViewerFilters';
...
// this function merge chart's formData with reportViewer filters value,
...
export default function getFormDataWithExtraFilters({
  ...
  // if reportViewer metadata + filters have not changed, use cache if possible
