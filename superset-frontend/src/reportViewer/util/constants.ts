 ...
 */
// Ids
export const REPORTVIEWER_GRID_ID = 'GRID_ID';
export const REPORTVIEWER_HEADER_ID = 'HEADER_ID';
export const REPORTVIEWER_FOOTER_ID = 'FOOTER_ID';
export const REPORTVIEWER_ROOT_ID = 'ROOT_ID';
export const REPORTVIEWER_VERSION_KEY = 'REPORTVIEWER_VERSION_KEY';
...
// grid constants
export const REPORTVIEWER_ROOT_DEPTH = 0;
...
export const SAVE_TYPE_NEWREPORTVIEWER = 'newReportViewer';

// default reportViewer layout data size limit
// could be overwritten by server-side config
export const REPORTVIEWER_POSITION_DATA_LIMIT = 65535;

// in-component element types: can be added into
// directPathToChild, used for in reportViewer navigation and focus
...
export enum ReportViewerStandaloneMode {
  None = 0,
  HideNav = 1,
  HideNavAndTitle = 2,
  ReportViewer = 3,
