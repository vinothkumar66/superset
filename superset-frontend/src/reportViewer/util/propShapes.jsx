...
export const reportViewerFilterPropShape = PropTypes.shape({
...
export const reportViewerStatePropShape = PropTypes.shape({
...
export const reportViewerInfoPropShape = PropTypes.shape({
  id: PropTypes.number,
  metadata: PropTypes.object,
  slug: PropTypes.string,
  reportedit_perm: PropTypes.bool,
  reportsave_perm: PropTypes.bool,
