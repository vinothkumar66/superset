 ...
 * under the License.
 */
import { SupersetPluginChartCandlestickPlot } from '../src';
 ...
 */
describe('superset-plugin-chart-candlestick-plot', () => {
  it('exists', () => {
    expect(SupersetPluginChartCandlestickPlot).toBeDefined();
  });
});
